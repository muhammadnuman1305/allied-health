...
export default function AdminInterventionsSetupPage() {
  ...
  const handleAction = (action: string, id: string) => {
    ...
    if (!it) return;
    if (action === "edit") {
      router.push(`/admin/setup/interventions/${id}`);
      return;
    }
    setActionDialog({
      isOpen: true,
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                onClick={() => router.push("/admin/setup/interventions/0")}
            ...
            actions={(row) => (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem
                    onClick={() =>
                      router.push(`/admin/setup/interventions/${row.id}`)
                    }
                  >
                    <Edit className="mr-2 h-4 w-4" /> Edit Intervention
                  </DropdownMenuItem>
                  <DropdownMenuItem
