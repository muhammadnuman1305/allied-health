...
export default function TasksPage() {
  ...
  // Users can only update status and save final outcome, not create or delete tasks
  ...
  const handleCompleteTask = (taskId: string) => {
    if (!outcomeNotes.trim()) {
      // Show error or warning - outcome notes required for completion
      return;
    }
    setTasks(
      tasks.map((task) =>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {task.status !== "completed" && (
                      <>
                        <Dialog
                          open={
                            isStatusDialogOpen && selectedTask?.id === task.id
                          }
                          onOpenChange={(open) => {
                        ...
                        <Dialog
                          open={
                            isCompleteDialogOpen && selectedTask?.id === task.id
                          }
                          onOpenChange={(open) => {
                            ...
                            <div className="space-y-4">
                              <div>
                                ...
                                <Textarea
                                  ...
                                  placeholder="Enter the final outcome of this task..."
                                  rows={5}
                                  required
                                />
