...
const mockReferrals: Referral[] = [
  {
    ...
    status: "completed",
    notes:
      "Patient shows signs of hypertension. BP readings consistently above 140/90.",
  ...
  },
  {
    ...
    status: "completed",
    notes:
      "Fasting glucose levels consistently above 126 mg/dL. Patient reports increased thirst and frequent urination.",
  ...
  },
  {
    ...
    status: "completed",
    notes:
      "Patient underwent ACL reconstruction surgery. Requires physical therapy for rehabilitation.",
  ...
  },
  {
    ...
    status: "accepted",
    notes:
      "Patient seeking assistance with weight loss. BMI indicates overweight category.",
  ...
  },
  {
    ...
    status: "pending",
    notes:
      "Patient experiencing severe headaches and dizziness. Cardiac evaluation normal.",
...
export default function ReferralsPage() {
  ...
  // Users cannot create, update, or delete referrals - view only
  const handleStatusChange = (
    referralId: string,
    newStatus: Referral["status"]
  ) => {
    // Users can only view referrals, status changes require admin approval
    // This is kept for UI consistency but doesn't actually update
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatsCard
          title="Completed"
          value={referralCounts.completed}
          description="Successfully done"
          icon={CheckCircle}
        />
        <StatsCard
          title="Rejected"
          value={referralCounts.rejected}
        ...
        <CardContent>
          <div className="space-y-4">
            {filteredReferrals.map((referral) => {
              ...
              const priority =
                priorityConfig[
                  referral.priority as keyof typeof priorityConfig
                ];
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        {selectedReferral && (
                          <ReferralDetailView referral={selectedReferral} />
                        )}
                      </DialogContent>
                    </Dialog>
                      ...
                      <DialogContent className="max-w-md">
                        ...
                        {selectedReferral && (
                          <AddFeedbackForm
                            ...
                            onSubmit={(feedback) =>
                              handleAddFeedback(selectedReferral.id, feedback)
                            }
                          />
                        )}
                      </DialogContent>
...
function EditReferralForm({
  ...
  referral: Referral;
  onSubmit: (updates: Partial<Referral>) => void;
}) {
  const [formData, setFormData] = useState({
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, status: value as Referral["status"] })
            }
          >
            <SelectTrigger>
              <SelectValue />
...
function ReferralDetailView({ referral }: { referral: Referral }) {
  ...
  const priority =
    priorityConfig[referral.priority as keyof typeof priorityConfig];
  const StatusIcon = status.icon;
